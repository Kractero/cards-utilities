...
for idx, k in enumerate(puppets):
	...
	links.write("""<td><p><a target="_blank" href="{}">Link to Nation</a></p></td>""".format(f"https://www.nationstates.net/nation={canonical}/page=upload_flag/test=1", canonical, canonical))
	links.write("""</tr>\n""")
